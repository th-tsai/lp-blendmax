"""
BlendMax Production Planning
"""

from pathlib import Path

from src.data import BlendMaxRawData
from src.model import BlendMax
...
def main() -> None:
    ...
    for case_dir in sorted(data_dir.iterdir()):
        ...
        if not toml_path.exists():
            continue
        raw = BlendMaxRawData.load_from_toml(toml_path)
        solution = BlendMax(raw.structured()).solve()
